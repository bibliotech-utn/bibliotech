"""
Comando de Django para importar autores desde un archivo Excel.
Uso: python manage.py importar_autores archivo.xlsx [--actualizar]
"""
from django.core.management.base import BaseCommand, CommandError
from gestion_autores.importadores.autores_importer import importar_autores_desde_excel
import os


class Command(BaseCommand):
    help = 'Importa autores desde un archivo Excel (.xlsx)'
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--actualizar',
            action='store_true',
            help='Actualizar autores existentes (mismo nombre y apellido)',
        )
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f'Importando autores desde: {archivo}'))
        self.stdout.write('')
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS(f'✓ Autores importados: {resultados["importados"]}'))
            self.stdout.write(self.style.WARNING(f'⚠ Autores actualizados: {resultados["actualizados"]}'))
            self.stdout.write(self.style.WARNING(f'⚠ Autores omitidos: {resultados["omitidos"]}'))
